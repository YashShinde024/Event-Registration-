...
<script>
  // base URL of your app, e.g. "" or "/event-registration-servlet"
  ...
  async function fetchEvents(){
    ...
    try {
      ...
      data.forEach(evt=>{
        ...
        col.innerHTML = `<div class="card event-card h-100"><div class="card-body">
          ...
          <button class="btn btn-sm btn-outline-primary viewBtn">View</button></div></div>`;
  ...
  function openModal(evt){
    ...
    document.getElementById('modalDetails').innerText = `\${evt.location} • \${new Date(evt.datetime).toLocaleString()}\n\n\${evt.description||''}`;
