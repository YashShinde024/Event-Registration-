...
public class RegistrationDao {
  ...
  public void create(Registration r) throws SQLException {
    try (Connection c = DbUtil.getConnection();
         PreparedStatement ps = c.prepareStatement(
           "INSERT INTO registrations (event_id,name,email,phone,remarks,created_at) VALUES (?,?,?,?,?,?)",
  ...
  public List<Registration> findAll() throws SQLException {
    ...
    try (Connection c = DbUtil.getConnection();
         PreparedStatement ps = c.prepareStatement("SELECT * FROM registrations ORDER BY created_at DESC")) {
  ...
  public List<Registration> findByEventId(long eventId) throws SQLException {
    List<Registration> list = new ArrayList<>();
    try (Connection c = DbUtil.getConnection();
         PreparedStatement ps = c.prepareStatement("SELECT * FROM registrations WHERE event_id = ? ORDER BY created_at DESC")) {
